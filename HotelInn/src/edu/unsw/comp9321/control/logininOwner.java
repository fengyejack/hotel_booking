...
public class logininOwner implements Command{
	
	static Logger logger = Logger.getLogger(logininOwner.class.getName());
	...
	public String execute(HttpServletRequest request,
		...
		try {
			...
			if(castuser.getByLogin(username,password,"OWNER")>0){
				request.getSession().setAttribute("occupancy", castspecific.getOccupancy());
